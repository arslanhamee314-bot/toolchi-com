...
export default function RootLayout({
  ...
  const orgLd = {
    ...
    name: "Toolchi",
    url: "https://toolchi.online",
    logo: "https://toolchi.online/logo.jpg",
    founder: {
      "@type": "Person",
      name: "Arslan Hameed",
    },
    sameAs: [
      ...
      "https://x.com/toolchi_online",
      "https://linkedin.com/company/toolchi",
    ],
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <div className="md:col-span-4 space-y-4 text-left">
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    <a 
                      href="https://github.com/arslanhamee314-bot" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="p-2 rounded-lg bg-neutral-50 hover:bg-neutral-100 dark:bg-card dark:hover:bg-neutral-800 border border-border text-muted-foreground hover:text-foreground transition-all cursor-pointer"
                      title="GitHub"
                    >
                    ...
                    <a 
                      href="https://x.com/toolchi_online" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="p-2 rounded-lg bg-neutral-50 hover:bg-neutral-100 dark:bg-card dark:hover:bg-neutral-800 border border-border text-muted-foreground hover:text-foreground transition-all cursor-pointer"
                      title="X (Twitter)"
                    ...
                    <a 
                      href="https://linkedin.com/company/toolchi" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="p-2 rounded-lg bg-neutral-50 hover:bg-neutral-100 dark:bg-card dark:hover:bg-neutral-800 border border-border text-muted-foreground hover:text-foreground transition-all cursor-pointer"
                      title="LinkedIn"
