...
const RAW_TOOLS_REGISTRY = [
  ...
  { slug: "audio-speed", name: "Audio Speed", category: "audio", shortDesc: "Speed up or slow down audio files without pitch distortion.", iconName: "Gauge" },
  { slug: "audio-denoise", name: "Audio Denoise", category: "audio", shortDesc: "Remove background noise and hiss from audio recordings.", iconName: "AudioWaveform" },
  ...
  { slug: "barcode-generator", name: "Barcode Generator", category: "operational", shortDesc: "Generate Code-128 barcodes from text strings and download as PNG.", iconName: "BarChart" },
  { slug: "image-to-base64", name: "Image to Base64", category: "developer", shortDesc: "Encode any image file into a Base64 Data URI string.", iconName: "Binary" },
...
const CUSTOM_TOOL_PROPERTIES: Record<string, Partial<ToolItem>> = {
  ...
  "barcode-generator": { ctaText: "Generate Barcode", sampleSupported: true, relatedSlugs: ["qr-generator"], isNew: true },
  "image-to-base64": { ctaText: "Encode Image", sampleSupported: false, relatedSlugs: ["base64"], isNew: true },
  "audio-speed": { ctaText: "Change Speed", sampleSupported: false, relatedSlugs: ["audio-cutter"], isNew: true },
  "audio-denoise": { ctaText: "Denoise Audio", sampleSupported: false, relatedSlugs: ["audio-cutter"], isNew: true },
  "video-loop": { ctaText: "Create Loop", sampleSupported: false, relatedSlugs: ["video-cutter"], isNew: true },
